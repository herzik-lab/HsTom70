...
folders = [ os.path.expandvars("calc_hdx_pD8_Temp298_default_betas_dt_str") ]
# The path to the target experimental data file
expt = os.path.expandvars("TOM_expt_dfracs.dat")
# The path to the file containing intrinsic rates for each residue in your protein, generated by calc_hdx
rates = os.path.expandvars("calc_hdx_pD8_Temp298_default_betas_dt_str/Combined_Intrinsic_rates.dat")
