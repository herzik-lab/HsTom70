...
usrNodeGroups["PROA"] = {}
usrNodeGroups["PROA"]["N1"] = set("N1 C2 O2 N3 C4 O4 C5 C6 C7 OA OB".split())
usrNodeGroups["PROA"]["P"] = set("P OP1 OP2 OP3 O5' C5' C4' O4' C1' C3' C2' O2' O3'".split())
...
num_nodes = dnap.interfaceAnalysis(selAstr="segid PROA", selBstr="segid PROA")
...
pathToData = "/home/klmcguire/MAX/Paper1/DNA/Open/Combined_Trajectories/AnalysisResults"

fileNameRoot = "Open_Combined"
