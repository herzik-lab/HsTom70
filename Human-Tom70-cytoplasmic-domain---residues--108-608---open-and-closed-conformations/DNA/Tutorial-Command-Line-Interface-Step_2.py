...
tags["PROAn"] = getNodeFromSel("resname PROA and name N1", dnad.nodesAtmSel, dnad.atomToNode)[0]

tags["PROAp"] = getNodeFromSel("resname PROA and name P", dnad.nodesAtmSel, dnad.atomToNode)[0]
...
print(df.loc[ (df["resid"] == "Proa:301_PROA") & (df["window"] == 0)  ])
